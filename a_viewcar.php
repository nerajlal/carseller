...
<!--main content start-->
    <section id="main-content">
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i>New Cars</h3>
        <div class="row mb">
          <!-- page start-->
          <div class="content-panel">
            <div class="adv-table">
              <table cellpadding="0" cellspacing="0" border="0" class="display table table-bordered">
               ...
               <tbody>
                 <?php
                	$q="SELECT * fROM CARS where status='0'";
                	// echo $q;
                            ...
                            <td><?php echo $r['Registration_no'] ?> </td>
                              <td><?php echo $r['km']?></td>
                               <td><?php  echo $r['photo']?></td>
                                ...
                                <td><a href="a_reply.php?id=<?php echo $r['carid'];?>" <form><input type='button' value="MESSAGE" style="background: green;color: white"></input></form></a></td>
                              ...
                              <td><a href="a_creject.php?id=<?php echo $r['carid'];?>" <form><input type='button' value="REJECT" style="background: green;color: white"></input></form></a></td><td>
