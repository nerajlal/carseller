...
<!--main content start-->
    <section id="main-content">
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i>Owned Cars</h3>
        <div class="row mb">
          <!-- page start-->
                        ...
                        <td><?php echo $r['body_type'] ?></td>
                          <td><?php echo $r['seller_ph'] ?></td>
                            <td><?php echo $r['Registration_no'] ?> </td>
                             ...
                             <td><a href="a_cdelete.php?id=<?php echo $r['carid'];?>" <form><input type='button' value="DELETE" style="background: green;color: white"></input></form></a></td><td>
