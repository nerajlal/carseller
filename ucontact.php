 ...
 <div class="page-heading contact-heading header-text" style="background-image: url(car/assets/images/heading-4-1920x500.jpg);">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
...
if(isset($_POST['msg']))
{
      ...
      $q="INSERT INTO CONTACT(senderid,name, email, subject, message) VALUES('$lid','$name','$email','$subject', '$message')";
